const Requestes = ({showRequest, setShowRequests, likedUsers, interestTags, navigate}) =>{
  ...
  [
    ...
    return (
        ...
        <>
             <div className="absolute left-0 top-full z-50 mt-2 w-[340px] rounded-2xl border border-[#FECDD3] bg-white p-3 shadow-xl shadow-[#2C2A26]/10">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    {likedUsers.length > 0 ? (
                        ...
                        {likedUsers.map((likedUser, index) => {
                          ...
                          return (
                            <div
                              ...
                              className="flex items-center gap-3 rounded-xl border border-[#FECDD3] bg-[#FFF8F8] p-2.5"
                            >
                              <img
                              ...
                              <button
                                ...
                                className="rounded-lg bg-[#B91C1C] px-2.5 py-1 text-[11px] font-semibold text-white hover:bg-[#991B1B]"
                              >
                                View
                              </button>
                            </div>
                      ...
                      <p className="rounded-xl border border-dashed border-[#FECDD3] bg-[#FFF8F8] px-3 py-4 text-xs text-[#A39E96]">
                    ...
                    {interestTags.length > 0 ? (
                      <div className="flex flex-wrap gap-2">
                        {interestTags.map((item) => (
                          <span
                            key={item}
                            className="rounded-full border border-[#FECDD3] bg-[#FFF8F8] px-2.5 py-1 text-xs text-[#5C574F]"
                          >
                            {item}
                          </span>
                        ))}
